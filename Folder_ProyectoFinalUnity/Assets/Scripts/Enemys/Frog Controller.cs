...
public class FrogController : RoutePatrolRandom
{
    [Header("Frog Data")]
    ...
    [SerializeField] public SkinnedMeshRenderer frogMesh;
    ...
    public event Action OnFrogKilled;
    ...
    private void KillEnemy()
    {
        ...
        movementForce = 0f;
        frogMesh.material = new Material(frogMesh.material);
        OnFrogKilled?.Invoke();
        StartCoroutine(DeadEnemyFrog());
    }
    IEnumerator DeadEnemyFrog()
    {
        float dissolveAmount = 0f;
        while (dissolveAmount < 1f)
        {
            dissolveAmount += Time.deltaTime * dissolveSpeed;
            frogMesh.material.SetFloat("_DissolveAmount", dissolveAmount);
            yield return null;
        }
